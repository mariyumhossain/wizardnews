...
{ 
 ...
 { 
    ...
    name: "Falco", 
    ate: new Date(Date.now() - 60000000) 
},
{ 
    id: 9, 
    upvotes: 102, 
...
{ 
    id: 13, 
    upvotes: 21, 
    title: "Mailing lists WN readers ought to know about?", content: "I love to subscribe to information feeds through mailing list subscription. What do you subscribe to that you think others would benefit by if they were to as well?", 
    name: "Dracod", 
...
const list = () => {
  return [...data] // Notice that we're returning a copy of the array, so the original data is safe.  
